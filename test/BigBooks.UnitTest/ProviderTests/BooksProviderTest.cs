...
namespace BigBooks.UnitTest.ProviderTests
{
    public class BooksProviderTest : BookStoreTest
    {
        ...
        public async Task BookUpdateDtoTitle(string updateValue, string expectedError)
        {
        ...
        public async Task BookUpdateDtoIsbn(string updateValue, string expectedError)
        {
            const int BOOK_KEY = 1;
